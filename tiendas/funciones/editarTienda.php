...
<body>
  ...
  <form id="registTienda-form" class="form" action="editarTienda.php?id=<?php echo $_GET['id'];?>" method="POST">
  <div class="form-row">
    ...
    <button type="submit" name="editarTienda" class="btn btn-primary">Editar</button>

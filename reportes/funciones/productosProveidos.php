...
<head>
    ...
    <title>Productos Proveidos</title>
...
<body>
    ...
    <br><br><br><br>
    <div class="container">
        <h2 class="mb-3">Listado de productos proveídos por los proveedores con contrato vigente.</h2>
        <a href="../generadores/generarProductosProveidos.php" class="btn pdfDownloader btnSubmit mb-2"><i class="pdfDownloaderIcon fas fa-file-pdf"></i>Generar</a>
        <table class="table">

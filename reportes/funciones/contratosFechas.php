...
<body>
    ...
    <br><br><br><br>
    <div class="container">
        <h2 class="mb-3">Listado de contratos con su fecha de inicio y su fecha de finalización</h2>
        <a href="../generadores/generarContratosFechas.php" class="btn pdfDownloader btnSubmit mb-2"><i class="pdfDownloaderIcon fas fa-file-pdf"></i>Generar</a>
        <table class="table">

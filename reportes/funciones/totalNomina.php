...
<body>
    ...
    <br><br><br><br>
    <div class="container">
        <h2 class="mb-3">Nomina de Empleados</h2>
        <a href="../generadores/generarTotalNomina.php" class="btn pdfDownloader btnSubmit mb-2"><i class="pdfDownloaderIcon fas fa-file-pdf"></i>Generar</a>
        ...
        <table class="table">
            ...
            <tfoot class="tfoot-custom">
                ...
                if (!empty($resultE) and mysqli_num_rows($resultE) > 0) {
                    while ($row = mysqli_fetch_array($resultE)) { ?>
                        <tr class="">
                            <td class="text-center" colspan="2">Total Nomina</td>

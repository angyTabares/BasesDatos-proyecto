...
<body>
    ...
    <br><br><br><br>
    <div class="container">
        <h2 class="mb-3">Mostrar por cargos la cantidad de empleados que tiene. Mostrar sólo aquellos cargos que tengan menos empleados que el cargo de Bodeguero.</h2>
        <a href="../generadores/generarCargosCantidad.php" class="btn pdfDownloader btnSubmit mb-2"><i class="pdfDownloaderIcon fas fa-file-pdf"></i>Generar</a>
        <table class="table">
                ...
                if (!empty($resultE) and mysqli_num_rows($resultE) > 0) {
                    while ($row = mysqli_fetch_array($resultE)) { ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['cantidad_empleados'] ?></td>
                        </tr>
                <?php }
                } ?>

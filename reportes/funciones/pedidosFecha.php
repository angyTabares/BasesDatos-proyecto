...
<body>
    ...
    <br><br><br><br>
    <div class="container">
        <h2 class="mb-3">Listado de pedidos con su respectiva fecha</h2>
        <a href="../generadores/generarPedidosFecha.php" class="btn pdfDownloader btnSubmit mb-2"><i class="pdfDownloaderIcon fas fa-file-pdf"></i>Generar</a>
        ...
        <table class="table">
            ...
            <tbody>
                <?php
                $query = "SELECT pedido.numero, pedido.fecha
                 from pedido";
